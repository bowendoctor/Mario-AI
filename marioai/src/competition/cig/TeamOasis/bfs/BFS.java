package competition.cig.TeamOasis.bfs;
...
public class BFS {
    ...
    public boolean[] search(){
        ...
        int debug = 0;
        while(!open.isEmpty() && node.worldstate.mario.x - start < 80){// reduce the range since too many nodes to store leading to lag
            //not die or block
            node = open.poll();
            node.generateChild();
